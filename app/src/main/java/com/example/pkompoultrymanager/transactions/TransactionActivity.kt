...
class TransactionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val drawerLayout = findViewById<DrawerLayout>(R.id.drawerLayout_TransactionActivity)
        val navView = findViewById<NavigationView>(R.id.navView_TransactionActivity)
    ...
    private fun setCurrentFragment(fragment: Fragment){
        supportFragmentManager.beginTransaction().apply {
            replace(R.id.flTransactionActivity, fragment)
            commit()
        }
    }
}