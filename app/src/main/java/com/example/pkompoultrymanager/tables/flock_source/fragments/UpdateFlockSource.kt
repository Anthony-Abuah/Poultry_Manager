...
class UpdateFlockSource : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_update_flock_source, container, false)

        mFlockSourceViewModel = ViewModelProvider(this)[FlockSourceViewModel::class.java]

        // Value holder views
        val tvName= view.findViewById<TextView>(R.id.tvFlockSourceName_UpdateFlockSource)
        val update= view.findViewById<Button>(R.id.btnUpdate_UpdateFlockSource)
        // Value holder views
        val etName= view.findViewById<EditText>(R.id.etFlockSourceName_UpdateFlockSource)
        val etContact= view.findViewById<EditText>(R.id.etFlockSourceContact_UpdateFlockSource)
    ...
    private fun updateDataInDatabase(
        ...
        if (checkIfEmpty(name)) {
            ...
            mFlockSourceViewModel.updateFlockSourceInfo(id,name,contact,location,shortNotes)
    ...
    private fun checkIfEmpty(flockSourceName: String): Boolean {
        return (TextUtils.isEmpty(flockSourceName))
    }
