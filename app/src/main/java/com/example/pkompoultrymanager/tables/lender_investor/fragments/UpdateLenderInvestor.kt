...
class UpdateLenderInvestor : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_update_lender_investor, container, false)
    ...
    private fun updateDataInDatabase(
        ...
        if (checkIfEmpty(name)) {
            ...
            mLenderInvestorViewModel.updateLenderInvestorInfo(id,name,contact,location,shortNotes)
