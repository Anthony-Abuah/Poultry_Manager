...
class FeedInventoryReductionForm : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =
            inflater.inflate(R.layout.fragment_feed_inventory_reduction_form, container, false)
        ...
        // display views
        val back = view.findViewById<ImageButton>(R.id.ibBack_FeedInventoryReductionForm)
        val save = view.findViewById<Button>(R.id.btnSave_FeedInventoryReductionForm)
        val tvEnterDate = view.findViewById<TextView>(R.id.tvEnterDate_FeedInventoryReductionForm)
        val llSelectFlock = view.findViewById<LinearLayout>(R.id.llSelectFlock_FeedInventoryReductionForm)
        val tvSelectFeed = view.findViewById<TextView>(R.id.tvSelectFeed_FeedInventoryReductionForm)
        val tvSelectFlock =
            view.findViewById<TextView>(R.id.tvSelectFlock_FeedInventoryReductionForm)
        val tvReductionReason =
            view.findViewById<TextView>(R.id.tvReductionReason_FeedInventoryReductionForm)
        val tvFeedQuantity =
            view.findViewById<TextView>(R.id.tvFeedQuantity_FeedInventoryReductionForm)
        // value holder views
        tvDatePicker = view.findViewById(R.id.tvDatePicker_FeedInventoryReductionForm)
        val etFeedQuantityUsed =
            view.findViewById<EditText>(R.id.etFeedQuantity_FeedInventoryReductionForm)
        val actvSelectFeed =
            view.findViewById<AutoCompleteTextView>(R.id.actvSelectFeed_FeedInventoryReductionForm)
        val actvSelectReductionReason =
            view.findViewById<AutoCompleteTextView>(R.id.actvReductionReason_FeedInventoryReductionForm)
        val actvSelectFlock =
            view.findViewById<AutoCompleteTextView>(R.id.actvSelectFlock_FeedInventoryReductionForm)
        val etShortNotes = view.findViewById<EditText>(R.id.etShortNotes_FeedInventoryReductionForm)
        ...
        mFeedInventoryAdditionViewModel.displayAllFeedInventoryAdditions.observe(viewLifecycleOwner) { feed ->
            feed.let { FeedTable ->
               ...
               for (feedNames in FeedTable){
                ...
                val feedAdapter = ArrayAdapter(requireContext(), androidx.appcompat.R.layout.support_simple_spinner_dropdown_item, theFeedNames.distinct())
        ...
        mFeedViewModel.displayAllFeeds.observe(viewLifecycleOwner) {
            ...
            val feedAdapter = ArrayAdapter(requireContext(), androidx.appcompat.R.layout.support_simple_spinner_dropdown_item, feedNames.distinct())
            actvSelectFeed.setAdapter(feedAdapter) }
        }
    ...
    private fun insertDataToDatabase(
        ...
        if (checkIfEmpty(date)) {
            ...
            Toast.makeText(requireContext(), "You can only add $feedName on $dateToday or before", Toast.LENGTH_LONG).show()
            ...
            val feedInventoryReductionDate = simpleDateFormat.parse(date)!!
            ...
            if (checkIfEmpty(flockName)) {
                ...
                val feedInventoryReduction = FeedInventoryReduction(
                    0,
                ...
                mFeedInventoryReductionViewModel.addFeedInventoryReduction(feedInventoryReduction)
