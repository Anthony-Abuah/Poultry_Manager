...
import com.example.pkompoultrymanager.inventory.eggs.addition.EggInventoryAdditionAdapter
...
class EggsAdditionList : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_eggs_addition_list, container, false)
        ...
        val dateFilter = view.findViewById<ImageView>(R.id.ivDateFilter_EggInventoryAdditionList)
        val popUpPosition = view.findViewById<ConstraintLayout>(R.id.clEggsAddition_EggsAdditionLayout)
        ...
        val eggInventoryAdditionList = view.findViewById<RecyclerView>(R.id.rvEggsAdditionList)
        //val position = eggInventoryAdditionList.size
        val adapter = EggInventoryAdditionAdapter(numberOfEggsPerCrates.toInt())
        eggInventoryAdditionList.adapter = adapter
        eggInventoryAdditionList.layoutManager = LinearLayoutManager(requireContext())

        mEggInventoryAdditionViewModel = ViewModelProvider(this)[EggInventoryAdditionViewModel::class.java]
        mEggInventoryAdditionViewModel.displayAllEggInventoryAdditions.observe(viewLifecycleOwner) {
                eggInventoryAddition -> adapter.setData(eggInventoryAddition)
        }
        ...
        dateFilter.setOnClickListener {
            ...
            popupDateFilterMenu.setOnMenuItemClickListener {
                when (it.itemId) {
                    R.id.miAllTime -> {
                        mEggInventoryAdditionViewModel.displayAllEggInventoryAdditions.observe(
                            viewLifecycleOwner
                        )
                        { eggInventoryAddition -> adapter.setData(eggInventoryAddition) }
                        true
                    ...
                    R.id.miToday -> {
                        mEggInventoryAdditionViewModel.displayAllEggInventoryAdditionByDate(
                            numberOfList,
                            thePreviousDay!!,
                            theCurrentDate!!
                            ...
                            setPositiveButton("Ok") { dialog, where ->
                                ...
                                if (checkIfEmpty(tvDatePickerFrom.text.toString())) {
                                    ...
                                    if (theFirstDate != null) { if (theLastDate != null) {
                                        mEggInventoryAdditionViewModel.displayAllEggInventoryAdditionByDate(listNumber, theFirstDate, theLastDate).observe(viewLifecycleOwner)
                                        { eggInventoryAddition -> adapter.setData(eggInventoryAddition) } } }
                                }
                            }
        ...
        adapter.setOnItemClickListener(object : EggInventoryAdditionAdapter.OnItemClickListener {
            override fun onDeleteEggInventoryAdditionClickListener(eggInventoryAddition: EggInventoryAddition, position: Int) {
                val popupMenu = PopupMenu(requireContext(), eggInventoryAdditionList[position].findViewById(R.id.ivUpdate_Delete_Menu_EggsAdditionLayout))
                ...
                popupMenu.setOnMenuItemClickListener {
                    when (it.itemId) {
                        R.id.miDelete -> {
                            ...
                            with(builder) {
                                ...
                                setNegativeButton("No") { dialog, which ->
                                    eggInventoryAdditionList.adapter = adapter
                                    eggInventoryAdditionList.layoutManager =
                                ...
                                setPositiveButton("Yes") { dialog, where ->
                                    mEggInventoryAdditionViewModel.delete(eggInventoryAddition)
                                    Toast.makeText(
                        ...
                        R.id.miUpdate -> {
                            ...
                            val eggInventoryId = eggInventoryAddition.EggInventoryAdditionId
                            val dateCollected = eggInventoryAddition.DateCollected.let { it1 -> simpleDateFormat.format(it1) }
                            val flock = eggInventoryAddition.Flock
                            val eggType = eggInventoryAddition.EggType
                            val numberOfEggs = eggInventoryAddition.EggQuantity.toString()
                            val shortNotes = eggInventoryAddition.ShortNotes
                            communicator = activity as EggsCommunicator
                            communicator.passEggInventoryAddition(
                                eggInventoryId,
                                dateCollected,
                                flock,
                                eggType,
            ...
            override fun onItemClickListener(eggInventoryAddition: EggInventoryAddition) {
                val eggInventoryId = eggInventoryAddition.EggInventoryAdditionId
                val dateCollected = eggInventoryAddition.DateCollected.let { it1 -> simpleDateFormat.format(it1) }
                val flock = eggInventoryAddition.Flock
                val eggType = eggInventoryAddition.EggType
        ...
        val back = view.findViewById<ImageView>(R.id.ivBack_EggInventoryAdditionList)
        back.setOnClickListener {
            startActivity(Intent(context, InventoryActivity::class.java))
        }

        val addEggInventory = view.findViewById<FloatingActionButton>(R.id.fabAddEggInventory)
        addEggInventory.setOnClickListener {
