...
class UpdateFlockAdditionForm : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_update_flock_addition_form, container, false)
        ...
        // Declaring the Views
        // display views
        val tvSelectFlockPurpose =
            view.findViewById<TextView>(R.id.tvFlockPurpose_UpdateFlockInventoryAdditionForm)
        val tvSelectFlockSource =
            view.findViewById<TextView>(R.id.tvFlockSource_UpdateFlockInventoryAdditionForm)
        val tvEnterDate =
            view.findViewById<TextView>(R.id.tvEnterDate_UpdateFlockInventoryAdditionForm)
        val tvFlockName =
            view.findViewById<TextView>(R.id.tvFlockName_UpdateFlockInventoryAdditionForm)
        val tvFlockAge =
            view.findViewById<TextView>(R.id.tvFlockAge_UpdateFlockInventoryAdditionForm)
        val tvFlockQuantity =
            view.findViewById<TextView>(R.id.tvFlockQuantity_UpdateFlockInventoryAdditionForm)
        val tvFlockBreed =
            view.findViewById<TextView>(R.id.tvFlockBreed_UpdateFlockInventoryAdditionForm)
        val tvFlockCost =
            view.findViewById<TextView>(R.id.tvFlockCost_UpdateFlockInventoryAdditionForm)
        val ivAddFlockSource =
            view.findViewById<ImageView>(R.id.ivAddFlockSource_UpdateFlockInventoryAdditionForm)
        val back = view.findViewById<ImageButton>(R.id.ibBack_UpdateFlockInventoryAdditionForm)
        val update = view.findViewById<Button>(R.id.btnUpdate_UpdateFlockInventoryAdditionForm)

        // value holder views
        tvDatePicker = view.findViewById(R.id.tvDatePicker_UpdateFlockInventoryAdditionForm)
        val etFlockName =
            view.findViewById<EditText>(R.id.etFlockName_UpdateFlockInventoryAdditionForm)
        val etFlockAge =
            view.findViewById<EditText>(R.id.etFlockAge_UpdateFlockInventoryAdditionForm)
        val etFlockQuantity =
            view.findViewById<EditText>(R.id.etFlockQuantity_UpdateFlockInventoryAdditionForm)
        val etFlockBreed =
            view.findViewById<EditText>(R.id.etFlockBreed_UpdateFlockInventoryAdditionForm)
        val etFlockCost =
            view.findViewById<EditText>(R.id.etFlockCost_UpdateFlockInventoryAdditionForm)
        val etShortNotes =
            view.findViewById<EditText>(R.id.etShortNotes_UpdateFlockInventoryAdditionForm)
        val actvSelectFlockPurpose =
            view.findViewById<AutoCompleteTextView>(R.id.actvFlockPurpose_UpdateFlockInventoryAdditionForm)
        val actvSelectFlockSource =
            view.findViewById<AutoCompleteTextView>(R.id.actvFlockSource_UpdateFlockInventoryAdditionForm)
        ...
        val selectFlockPurposeAdapter = ArrayAdapter(
            requireContext(),
            androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,
            flockPurposeSuggestions
        )
        ...
        mFlockSourceViewModel.displayAllFlockSources.observe(viewLifecycleOwner) { flockSources ->
            flockSources.let {
                val flockSourceNames = mutableListOf<String>()
                for (FlockSource in it) {
                    flockSourceNames.add(FlockSource.FlockSourceName)
                }
                val flockSourceAdapter = ArrayAdapter(
                    requireContext(),
                    androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,
                    flockSourceNames
                )
        ...
        val theFlockInventoryAdditionId = arguments?.getString("flockInventoryAdditionId")!!
        val theDateAdded = arguments?.getString("dateAdded")!!
        val theFlockName = arguments?.getString("flockName")!!
        val theFlockBreed = arguments?.getString("flockBreed")!!
        val theFlockSource = arguments?.getString("flockSource")!!
        val theFlockPurpose = arguments?.getString("flockPurpose")!!
        val theFlockQuantity = arguments?.getString("flockQuantity")!!
        val theFlockAge = arguments?.getString("flockAge")!!
        ...
        tvDatePicker.text = theDateAdded
        etFlockName.setText(theFlockName)
        etFlockBreed.setText(theFlockBreed)
        actvSelectFlockPurpose.setText(theFlockPurpose)
        actvSelectFlockSource.setText(theFlockSource)
        etFlockQuantity.setText(theFlockQuantity)
        etFlockAge.setText(theFlockAge)
        ...
        update.setOnClickListener {
            updateFlockInventoryReduction(
                theFlockInventoryAdditionId.toInt(),
                tvDatePicker,
                tvEnterDate,
                tvFlockName,
                etFlockName,
                ...
                etFlockAge,
                etFlockBreed,
                tvSelectFlockPurpose,
                actvSelectFlockPurpose,
                tvFlockCost,
                etFlockCost,
                actvSelectFlockSource,
                etShortNotes,
                dateToday,
                flockNames,
                theFlockName
    ...
    private fun updateFlockInventoryReduction(
        ...
        if (checkIfEmpty(date)) {
            ...
            Toast.makeText(
                requireContext(),
                "You can only add $flockName on $dateToday or before",
                Toast.LENGTH_SHORT
            ).show()
            ...
            if (flockName == theFlockName){
                flockNameAlreadyExists = false
            }
            if (flockNameAlreadyExists){
                ...
                val flockInventoryAdditionDate = newDate?.time?.let { java.sql.Date(it) }!!

                // update the data via the viewModel
                mFlockInventoryAdditionViewModel.updateFlockInventoryAddition(
                    flockInventoryAdditionId,
                    flockName,
                    flockInventoryAdditionDate,
                    flockQuantity.toDouble(),
                    flockSource,
                    flockCost.toDouble(),
                    flockAge.toInt(),
                    flockPurpose,
