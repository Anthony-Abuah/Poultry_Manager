...
class UpdateEggsReductionForm : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_update_eggs_reduction_form, container, false)
        ...
        val numberOfEggsPerCrate = myFarmInfo.getInt("numberOfEggsPerCrate",30)
        ...
        //display views
        val update = view.findViewById<Button>(R.id.btnUpdate_UpdateEggsInventoryReductionForm)
        val back = view.findViewById<ImageButton>(R.id.ibBack_UpdateEggsInventoryReductionForm)
        val tvEggType = view.findViewById<TextView>(R.id.tvEggsType_UpdateEggsInventoryReductionForm)
        val tvReductionReason = view.findViewById<TextView>(R.id.tvReductionReason_UpdateEggsInventoryReductionForm)
        val tvEnterDate = view.findViewById<TextView>(R.id.tvEnterDate_UpdateEggsInventoryReductionForm)
        val tvNumberOfCrates = view.findViewById<TextView>(R.id.tvNumberOfEggCrates_UpdateEggsInventoryReductionForm)
        val tvNumberEggsNotInCrates = view.findViewById<TextView>(R.id.tvNumberOfEggsNotInCrates_UpdateEggsInventoryReductionForm)
        //value holder views
        tvDatePicker = view.findViewById(R.id.tvDatePicker_UpdateEggsInventoryReductionForm)
        val etNumberOfCrates = view.findViewById<EditText>(R.id.etNumberOfEggCrates_UpdateEggsInventoryReductionForm)
        val etShortNotes = view.findViewById<EditText>(R.id.etShortNotes_UpdateEggsInventoryReductionForm)
        val etNumberOfEggsNotInCrates = view.findViewById<EditText>(R.id.etNumberOfEggsNotInCrates_UpdateEggsInventoryReductionForm)
        val actvSelectReductionReason = view.findViewById<AutoCompleteTextView>(R.id.actvEggReductionReason_UpdateEggsInventoryReductionForm)
        val actvSelectEggType = view.findViewById<AutoCompleteTextView>(R.id.actvEggsType_UpdateEggsInventoryReductionForm)


        //declaring Add Customer Views
        val llAddCustomer = view.findViewById<LinearLayout>(R.id.llAddCustomer_UpdateEggsInventoryReductionForm)
        val llSelectCustomer = view.findViewById<LinearLayout>(R.id.llSelectCustomer_UpdateEggsInventoryReductionForm)
        val etEggCost = view.findViewById<EditText>(R.id.etCost_UpdateEggsInventoryReductionForm)
        val actvSelectCustomer = view.findViewById<AutoCompleteTextView>(R.id.actvSelectCustomer_UpdateEggsInventoryReductionForm)
        val tvAmountTheCustomerPaid = view.findViewById<EditText>(R.id.etAmountPaid_UpdateEggsInventoryReductionForm)
        val tvEggCost = view.findViewById<TextView>(R.id.tvCost_UpdateEggsInventoryReductionForm)
        val tvCustomer = view.findViewById<TextView>(R.id.tvCustomer_UpdateEggsInventoryReductionForm)
        ...
        val theEggInventoryReductionID = arguments?.getString("eggInventoryReductionId")
        ...
        val theAmountCustomerPaid = arguments?.getString("amountPaid")
        val theNumberOfEggs = arguments?.getString("numberOfEggs")
        val theCustomer = arguments?.getString("customer")
        val theEggCost = arguments?.getString("eggCost")
        val theShortNotes = arguments?.getString("shortNotes")

        val theNumberOfEggsRemaining = theNumberOfEggs?.toInt()?.rem(numberOfEggsPerCrate)
        val theNumberOfEggCrates = theNumberOfEggs?.toInt()?.div(numberOfEggsPerCrate)

        // set the values to their corresponding views
        ...
        if(actvSelectReductionReason.text.toString()=="sold" || actvSelectReductionReason.text.toString()=="Sold"){
            ...
            tvAmountTheCustomerPaid.setText(theAmountCustomerPaid)
            etEggCost.setText(theEggCost)
        }
        if (theNumberOfEggCrates != null) {
            etNumberOfCrates.setText(theNumberOfEggCrates.toString())
        }
        if (theNumberOfEggsRemaining != null) {
            etNumberOfEggsNotInCrates.setText(theNumberOfEggsRemaining.toString())
        }
        etShortNotes.setText(theShortNotes)

        // add to the egg reduction inventory
        update.setOnClickListener {
            updateEggInventoryReduction(
                theEggInventoryReductionID?.toInt()!!,
                tvDatePicker,
                tvEnterDate,
                tvEggType,
                actvSelectEggType,
    ...
    private fun updateEggInventoryReduction(
        ...
        if (checkIfEmpty(date)) {
            ...
            if (checkIfEmpty(customer)) {
                ...
                val eggInventoryReductionDate = newDate?.time?.let { java.sql.Date(it)}

                // get the amount the customer owes
                val amountOwed = (eggCost.toDouble() - amountPaidByCustomer.toDouble())

                if (eggInventoryReductionDate != null) {
                    mEggInventoryReductionViewModel.updateEggInventoryReduction(eggInventoryReductionId,
                        eggInventoryReductionDate,
                        reductionReason,
                        eggType,
                        eggQuantity,
                        customer,
    ...
    private fun checkIfEggsAreNotBeingReduced(value: String, value1: String): Boolean {
        return (TextUtils.isEmpty(value) && TextUtils.isEmpty(value))
    }
